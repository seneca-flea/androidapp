...
/*
    The class was created and designed by Oleg Mytryniuk
    Notification Part was designed by Ricardo Mezza
                    ...
                    if (items != null) {
                        ...
                        try {
                            ...
                            if (myMessagesList.contains("false")) {
                                ...
                                messages.setImageResource(R.drawable.bt5mymessagesgot);
